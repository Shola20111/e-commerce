...
const NewArival = ()=>{
	return(
		<div className=" w-full h-auto flex flex-col gap-4 overflow-hidden ">
			...
			<div className="w-full h-[600px] grid grid-cols-2 gap-4">
				...
				<div className="grid grid-rows-2 gap-4">
					...
					<div className="grid grid-cols-2 gap-4">
						<div className="w-full h-full bg-black flex justify-center items-center relative ">
							...
							<div className="absolute left-8 bottom-8 w-[242px] flex flex-col gap-3" >
								<h2 className="text-[24px] leading-[24px] tracking-[3%] text-[#FAFAFA] font-semibold ">Speaker</h2>
								<p className="text-[14px] text-[#FAFAFA] leading-[21px] ">Amazon wireless speakers</p>
								<div className="font-medium text-[16px] text-[#fff] leading-[24px] ">Shop Now</div>
							</div>
						</div>
						<div className="w-full h-full bg-black flex justify-center items-center relative ">
							<Image src='/perfume.png' width={190} height={221} alt="Speakers" className="h-[85%] w-[85%" />
							<div className="absolute left-8 bottom-15 w-[242px] flex flex-col gap-3" >
								<h2 className="text-[24px] leading-[24px] tracking-[3%] text-[#FAFAFA] font-semibold ">Perfume</h2>
								<p className="text-[14px] text-[#FAFAFA] leading-[21px] ">GUCCI INTENSE OUD EDP</p>
								<div className="font-medium text-[16px] text-[#fff] leading-[24px] ">Shop Now</div>
							</div>
						</div>
					</div>
